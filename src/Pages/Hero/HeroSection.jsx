...
function AppSlider() {
  ...
  return (
    <div className={styles.sliderWrap}>
      ...
      <div className={styles.dots} role="tablist" aria-label="شرائح التطبيق">
        {Slides.map((slide, i) => (
          <button
            key={i}
            role="tab"
      ...
      {/* <div className={`${styles.floatCard} ${styles.floatCard1}`}>
        ...
        <div>
          <p className={styles.floatVal}>١٥٠+ مدرّس</p>
          <p className={styles.floatLabel}>معتمدون بإجازة</p>
        </div>
      </div> */}
      {/* <div className={`${styles.floatCard} ${styles.floatCard2}`}>
        <span className={styles.floatIcon}>⭐</span>
        <div>
          <p className={styles.floatVal}>٤.٩ / ٥</p>
          <p className={styles.floatLabel}>تقييم المنصة</p>
        </div>
      </div> */}
    </div>
  );
      ...
      <div className={styles.heroInner}>
        <div className={styles.heroLeft}>
          ...
          <h1 className={styles.title}>
            تعلّم الإسلام
            <span className={styles.titleAccent}>بأسلوب عصري</span>
          </h1>
          ...
          <div className={styles.pills}>
            {["بدون واتساب", "تذكير تلقائي", "شهادات معتمدة"].map((label) => (
